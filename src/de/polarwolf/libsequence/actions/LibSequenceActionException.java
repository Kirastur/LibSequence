...
public class LibSequenceActionException extends LibSequenceException {
	...
	protected final LibSequenceActionErrors errorCode; 
	...
	public LibSequenceActionException(String contextName, LibSequenceActionErrors errorCode, String errorDetailText, Throwable cause) {
