...
public class LibSequenceRunException extends LibSequenceException {
	...
	protected final LibSequenceRunErrors errorCode;

	
	public LibSequenceRunException(String sequenceName, int stepNr, LibSequenceRunErrors errorCode, String errorDetailText) {
	...
	public LibSequenceRunException(String sequenceName, int stepNr, LibSequenceRunErrors errorCode, String errorDetailText, Throwable cause) {
