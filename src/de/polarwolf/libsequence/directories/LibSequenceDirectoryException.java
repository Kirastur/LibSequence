...
public class LibSequenceDirectoryException extends LibSequenceException {
	...
	public LibSequenceDirectoryException(String contextName, LibSequenceDirectoryErrors errorCode, String errorDetailText) {
		super(contextName, errorCode.toString(), errorDetailText);
		this.errorCode = errorCode;
	}


	public LibSequenceDirectoryException(String contextName, LibSequenceDirectoryErrors errorCode, String errorDetailText, Throwable cause) {
